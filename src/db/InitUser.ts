...
import migrationUser20240612 from "./migration/User/20240612";
import migrationUser20240618 from "./migration/User/20240618";

db.serialize(() => {
  //migration
  migrationUser20240612(); //inboxカラム追加
  migrationUser20240618(); //messageReadIdからmessageReadTimeへ
